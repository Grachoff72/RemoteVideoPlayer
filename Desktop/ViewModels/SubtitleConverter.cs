...
{
	public class SubtitleConverter : IMultiValueConverter
	{
		...
		public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
		{
			...
			var subtitle = movie.Subtitles.FirstOrDefault(
				x => x.Begin.Ticks <= position && x.End.Ticks >= position);

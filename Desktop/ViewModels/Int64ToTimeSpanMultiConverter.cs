...
{
	public class Int64ToTimeSpanMultiConverter : IMultiValueConverter
	{
		...
		public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
		{
			...
			var duration = (long)values[0];
			var position = (long)values[1];
			...
			return new TimeSpan(duration - position).ToString(@"h\:mm\:ss");
		}
